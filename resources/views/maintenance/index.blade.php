    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Data Maintenance</h4>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        <h4 class="card-title mb-0">
                            <i class="ri-settings-3-line me-2"></i>Daftar Data Maintenance
                        </h4>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="maintenanceTable" class="table table-bordered table-striped table-hover">
                            <thead class="table-light align-middle">
                                <tr>
                                    ...
                                    <th width="15%">Tanggal Maintenance</th>
                                    <th width="15%">Aksi</th>
                                </tr>
                            </thead>
                        </table>
