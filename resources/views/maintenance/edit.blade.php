    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Edit Data Maintenance</h4>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">
                        <i class="ri-edit-line me-2"></i>Form Edit Data Maintenance
                    </h4>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_alat') is-invalid @enderror" 
                                           ...
                                           value="{{ old('nama_alat', $maintenance->nama_alat) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('merk_alat') is-invalid @enderror" 
                                           ...
                                           value="{{ old('merk_alat', $maintenance->merk_alat) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('tipe_alat') is-invalid @enderror" 
                                           ...
                                           value="{{ old('tipe_alat', $maintenance->tipe_alat) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tanggal_kalibrasi') is-invalid @enderror" 
                                           ...
                                           value="{{ old('tanggal_kalibrasi', $maintenance->tanggal_kalibrasi) }}" required>
