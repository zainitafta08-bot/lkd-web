    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Edit Data Instalasi</h4>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">
                        <i class="ri-edit-line me-2"></i>Form Edit Data Instalasi
                    </h4>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('instalasi.update', $instalasi->id) }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_alat') is-invalid @enderror" 
                                           ...
                                           value="{{ old('nama_alat', $instalasi->nama_alat) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('merk_alat') is-invalid @enderror" 
                                           ...
                                           value="{{ old('merk_alat', $instalasi->merk_alat) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('tipe_alat') is-invalid @enderror" 
                                           ...
                                           value="{{ old('tipe_alat', $instalasi->tipe_alat) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="tanggal_kalibrasi" class="form-label">
                                        Tanggal Instalasi <span class="text-danger">*</span>
                                    </label>
                                    <input type="date" class="form-control @error('tanggal_kalibrasi') is-invalid @enderror" 
                                           ...
                                           value="{{ old('tanggal_kalibrasi', $instalasi->tanggal_kalibrasi) }}" required>
                            ...
                            <div class="col-12">
                                <div class="d-flex gap-2 justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="ri-save-line me-1"></i> Update Data
                                    </button>
                                </div>
                            </div>
                        </div>
