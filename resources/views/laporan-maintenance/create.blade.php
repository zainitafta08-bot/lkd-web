    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Tambah Laporan Maintenance</h4>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">
                        <i class="ri-file-list-3-line me-2"></i>Form Tambah Laporan Maintenance
                    </h4>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('laporan-maintenance.store') }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tgl_maintenance') is-invalid @enderror" 
                                           ...
                                           value="{{ old('tgl_maintenance') }}" required>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('hasil') is-invalid @enderror" 
                                              ...
                                              placeholder="Masukkan hasil maintenance" required>{{ old('hasil') }}</textarea>
                                    @error('hasil')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
